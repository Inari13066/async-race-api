...
carIcon.src = `data:image/svg+xml;utf8,${carIconSVG}`;
...
innerCarContainer.append(startCarBtn, stopCarBtn, carIcon, finishIcon);

carNameContainer.append(selectCarBtn, removeCarBtn, carName);
carContainer.append(carNameContainer, innerCarContainer);

mainContainer.append(garageTitle, pageTitle, carContainer);
